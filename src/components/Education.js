      ...
      <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          <Details
            ...
            time="2016-2019"
            place="Institu Nationale des Sciences Appliquées (INSA)"
          ...
          <Details
            ...
            time="2013-2016"
            place="Institu Nationale des Sciences Appliquées (INSA)"
            info="Relevant science courses included Data Structures and Algorithms, Computer Systems Engineering, and Artificial Intelligence."
          />
